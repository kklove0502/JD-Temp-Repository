...
/* "thriftpy2/transport/cybase.pyx":5
 * 
 * 
 * cdef class TCyBuffer(object):             # <<<<<<<<<<<<<<
...
/* "thriftpy2/transport/cybase.pyx":105
 * 
 * 
 * cdef class CyTransportBase(object):             # <<<<<<<<<<<<<<
 ...
 *         self.cur = 0
 */
  __pyx_t_1 = __Pyx_PyInt_As_size_t(__pyx_v_buf_size); if (unlikely((__pyx_t_1 == (size_t)-1) && PyErr_Occurred())) __PYX_ERR(1, 7, __pyx_L1_error)
 ...
 *         self.data_size = 0
 */
  __pyx_t_2 = __Pyx_PyInt_As_int(__pyx_v_buf_size); if (unlikely((__pyx_t_2 == (int)-1) && PyErr_Occurred())) __PYX_ERR(1, 8, __pyx_L1_error)
 ...
 */
  ...
  /* "thriftpy2/transport/cybase.pyx":28
 *         cdef:
 *             int cap = self.buf_size - self.data_size
 *             int remain = cap - self.cur             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "thriftpy2/transport/cybase.pyx":37
 * 
 *         # recompute remain spaces
 *         remain = cap - self.cur             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "thriftpy2/transport/cybase.pyx":44
 * 
 *         memcpy(self.buf + self.cur + self.data_size, value, sz)
 *         self.data_size += sz             # <<<<<<<<<<<<<<
 * 
 ...
 */
    __pyx_t_8 = __Pyx_PyObject_AsWritableString(__pyx_v_new_data); if (unlikely((!__pyx_t_8) && PyErr_Occurred())) __PYX_ERR(1, 76, __pyx_L1_error)

    /* "thriftpy2/transport/cybase.pyx":77
 * 
 *             memcpy(self.buf + self.cur + self.data_size, <char*>new_data,
 *                    new_data_len)             # <<<<<<<<<<<<<<
 *             self.data_size += new_data_len
 ...
 */
  ...
  /* "thriftpy2/transport/cybase.pyx":81
 * 
 *         memcpy(out, self.buf + self.cur, sz)
 *         self.cur += sz             # <<<<<<<<<<<<<<
 *         self.data_size -= sz
 ...
 */
  ...
  /* "thriftpy2/transport/cybase.pyx":95
 * 
 *         cdef int new_size = self.buf_size * multiples
 *         cdef char *new_buf = <char*>malloc(new_size)             # <<<<<<<<<<<<<<
 *         if new_buf == NULL:
...
/* "thriftpy2/transport/cybase.pyx":106
 * 
 * cdef class CyTransportBase(object):
 *     cdef c_read(self, int sz, char* out):             # <<<<<<<<<<<<<<
 *         pass
...
/* "thriftpy2/transport/cybase.pyx":109
 *         pass
 * 
...
/* "thriftpy2/transport/cybase.pyx":112
 *         pass
 * 
 *     cdef c_flush(self):             # <<<<<<<<<<<<<<
 *         pass
 ...
 *             finally:
 */
      __pyx_t_2 = ((struct __pyx_vtabstruct_9thriftpy2_9transport_6cybase_CyTransportBase *)__pyx_v_self->__pyx_vtab)->c_read(__pyx_v_self, __pyx_v_sz, __pyx_v_dy_out); if (unlikely(!__pyx_t_2)) __PYX_ERR(1, 132, __pyx_L5_error)
      __Pyx_GOTREF(__pyx_t_2);
 ...
 */
      ...
      if (__pyx_t_1) {
        ...
        __pyx_t_4 = __Pyx_PyIndex_AsSsize_t(__pyx_t_2); if (unlikely((__pyx_t_4 == (Py_ssize_t)-1) && PyErr_Occurred())) __PYX_ERR(1, 133, __pyx_L5_error)
        __pyx_t_3 = __pyx_t_4;
      }
      __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
      __pyx_t_2 = __Pyx_PyBytes_FromStringAndSize(__pyx_v_dy_out + 0, __pyx_t_3 - 0); if (unlikely(!__pyx_t_2)) __PYX_ERR(1, 133, __pyx_L5_error)
      __Pyx_GOTREF(__pyx_t_2);
      __pyx_r = __pyx_t_2;
      __pyx_t_2 = 0;
 ...
 */
  /*else*/ {
    __pyx_t_2 = ((struct __pyx_vtabstruct_9thriftpy2_9transport_6cybase_CyTransportBase *)__pyx_v_self->__pyx_vtab)->c_read(__pyx_v_self, __pyx_v_sz, __pyx_v_out); if (unlikely(!__pyx_t_2)) __PYX_ERR(1, 137, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    __pyx_v_size = __pyx_t_2;
    __pyx_t_2 = 0;

    /* "thriftpy2/transport/cybase.pyx":138
 *         else:
 *             size = self.c_read(sz, out)
 *             return out[:size]             # <<<<<<<<<<<<<<
 */
    ...
    if (__pyx_t_1) {
      ...
      __pyx_t_4 = __Pyx_PyIndex_AsSsize_t(__pyx_t_2); if (unlikely((__pyx_t_4 == (Py_ssize_t)-1) && PyErr_Occurred())) __PYX_ERR(1, 138, __pyx_L1_error)
      __pyx_t_3 = __pyx_t_4;
    }
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
    __pyx_t_2 = __Pyx_PyBytes_FromStringAndSize(((const char*)__pyx_v_out) + 0, __pyx_t_3 - 0); if (unlikely(!__pyx_t_2)) __PYX_ERR(1, 138, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    __pyx_r = __pyx_t_2;
    __pyx_t_2 = 0;
    goto __pyx_L0;
